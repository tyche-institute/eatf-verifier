/**
 * Phase 1.20 v0.4 — pinned RFC 3161 TSA trust list, populated.
 *
 * <p>v0.2 (Phase 1.20) shipped the API surface but kept
 ...
 * the three DigiCert public root certificates that the EATF backend
 * chains against today via {@code https://timestamp.digicert.com}.
 *
 ...
 *   <li>When EATF Phase 1.24 lands a partner-QTSP timestamp service,
 *       add its root PEM + fingerprint to the same table.</li>
